...
public class Alarm {
    ...
    public Alarm(int alarmId, int hour, int minute, boolean sunday, boolean monday, boolean tuesday, boolean wednesday,
    ...
    public void setAlarm (Context context) {
        ...
        */
        ...
        String alarmConfirmation = String.format("Alarm (%s) set for %s at %d:%d", name, calendar.get(Calendar.DAY_OF_WEEK), hour, minute);
